...
#   sendConfigCommand (data) ->
#     data = new String(data)
#     unless data.lastIndexOf("OK") is -1
#       sendATCommand "ATRE", (data) ->
#         data = new String(data)
#         unless data.lastIndexOf("OK") is -1
#           sendATCommand "ATWR", (data) ->
#             data = new String(data)
#             unless data.lastIndexOf("OK") is -1
#               sendATCommand "ATCN", (data) ->
#                 data = new String(data)
#                 callback "true"  unless data.lastIndexOf("OK") is -1





# sendConfigCommand = (callback) ->
#   configMode = true
#   onConfigResponse = callback
#   send "+++"

# sendATCommand = (command, callback) ->
#   configMode = true
#   onConfigResponse = callback
#   send command + String.fromCharCode(13)

# send = (data) ->
#   console.log "--> " + toHex(data) + "\t\t" + data
#   serial.write data
